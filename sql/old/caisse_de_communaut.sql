...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 25 avr. 2018 à 08:59
...
--
-- Structure de la table `caisse de communaut`
--

DROP TABLE IF EXISTS `caisse de communaut`;
CREATE TABLE IF NOT EXISTS `caisse de communaut` (
...
--
-- Déchargement des données de la table `caisse de communaut`
--

INSERT INTO `caisse de communaut` (`id`, `Message`, `Type`) VALUES
(1, 'Allez au départ   ', 1),
(2, 'Allez en prison   ', 5),
